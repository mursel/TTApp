...
{
    public class PaketnaViewModel : INotifyPropertyChanged
    {

        public PaketnaViewModel(Paketna paketna = null) => Model = paketna ?? new Paketna();

        private Paketna model;
        public Paketna Model
        {
            get { return model; }
            set {
                if (model != value)
