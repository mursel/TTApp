...
namespace TrackAndTrace.Views.Admin
{
    ...
    /// </summary>
    public sealed partial class UposleniciPage : Page
    {
        ...
        {
            Frame.Navigate(typeof(UposlenikDetalji));
        }

        private void abrIzmjena_Click(object sender, RoutedEventArgs e)
        {
            Frame.Navigate(typeof(UposlenikDetalji), ViewModel.OdabraniUposlenik.Model.Id);
        }                
    }
}
