...
namespace TrackAndTrace.Views.Admin
{
    ...
    /// </summary>
    public sealed partial class ProizvodiPage : Page
    {
        ...
        {
            Frame.Navigate(typeof(ProizvodDetalji));
        }

        private void abrIzmjena_Click(object sender, RoutedEventArgs e)
        {
            Frame.Navigate(typeof(ProizvodDetalji), ViewModel.OdabraniProizvod.Model.Id);
        }                
    }
}
